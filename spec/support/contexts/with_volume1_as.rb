# Creates volume1 as described, inserts it into the rights and feed
...
RSpec.shared_context "with volume1 as" do |right, access_profile, timestamp|
  ...
  let(:volume1) do
    Datasets::Volume.new(
      namespace: "test", id: "001",
      access_profile: access_profile, right: right
    )
  end

  let(:volume1_rights_tuple) do
    {
      namespace: "test", id: "001",
      reason: 1, source: 2,
  ...
  before(:each) do
    feed_table.insert volume1_feed_tuple
    rights_table.insert volume1_rights_tuple
  end
end
